...
md = MarkItDown(
    llm_client=client,
    llm_model="anthropic/Codex-opus-4.5",  # recommended for scientific vision
...
md = MarkItDown(
    llm_client=client,
    llm_model="anthropic/Codex-opus-4.5",  # recommended for presentations
...
md_ai = MarkItDown(
    llm_client=client,
    llm_model="anthropic/Codex-opus-4.5",
